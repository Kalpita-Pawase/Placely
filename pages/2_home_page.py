...
st.markdown("<h6 style='color: gray;'>Your central dashboard for Placely insights</h6>", unsafe_allow_html=True)
st.markdown("---")
...
# Filters
st.markdown("<h5 style='color: black;'>Filter Student Data</h5>", unsafe_allow_html=True)
...
programming_df = run_query("SELECT * FROM programming")
st.dataframe(programming_df, use_container_width=True, hide_index=True)

st.markdown("<h5 style='color: black;'>Filter Programming Data</h5>", unsafe_allow_html=True)
...
if st.button("Show Programming Results"):
    ...
    st.info("Set filters and click 'Show Programming Results'")
...
soft_df = run_query("SELECT * FROM soft_skills")
st.dataframe(soft_df, use_container_width=True, hide_index=True)

st.markdown("<h5 style='color: black;'>Filter Soft Skills Data</h5>", unsafe_allow_html=True)
...
if st.button("Show Soft Skill Results"):
    ...
    st.info("Set filters and click 'Show Soft Skill Results'")
...
place_df = run_query("SELECT * FROM placements")
st.dataframe(place_df, use_container_width=True, hide_index=True)

st.markdown("<h5 style='color: black;'>Filter Placement Data</h5>", unsafe_allow_html=True)
