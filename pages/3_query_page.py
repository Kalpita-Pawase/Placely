...
st.markdown(
    "<h1 style='text-align: center; color: #FFBF00;'>Get Query Insights</h1>",
    unsafe_allow_html=True
)
st.markdown(
...
""",
    "All Students with gender = Other": """
    SELECT * FROM students WHERE gender = 'Other';
...
""",
    ...
    SELECT student_id, name, email, phone, enrollment_year FROM students WHERE enrollment_year = 2019;

""",
    "Students enrolled in 2020": """
    SELECT student_id, name, email, phone, enrollment_year FROM students WHERE enrollment_year = 2020;

""",
    "Students graduating in 2020": """
    SELECT student_id, name, email, phone, graduation_year FROM students WHERE graduation_year = 2020;
      
""",
    "Students graduating in 2021": """
    SELECT student_id, name, email, phone, graduation_year FROM students WHERE graduation_year = 2021;

""",
    "Students graduating in 2022": """
    SELECT student_id, name, email, phone, graduation_year FROM students WHERE graduation_year = 2022;

""",
    "Students graduating in 2023": """
    SELECT student_id, name, email, phone, graduation_year FROM students WHERE graduation_year = 20223;
...
""",
    "Pune - Batch-1 Students": """
    SELECT * FROM students WHERE city = 'Pune' AND course_batch = 'Batch-1';

""",
    "Pune - Batch-2 Students": """
    SELECT * FROM students WHERE city = 'Pune' AND course_batch = 'Batch-2';
""",
    "Tamil Nadu - Batch-1 Students": """
    SELECT * FROM students WHERE city = 'Tamil Nadu' AND course_batch = 'Batch-1';

""",
    "Tamil Nadu - Batch-2 Students": """
    SELECT * FROM students WHERE city = 'Tamil Nadu' AND course_batch = 'Batch-2';
...
""",
    "All 5 Project Completers": """
        SELECT * FROM programming WHERE mini_projects = 5;
        
""",
    "Language Count": """
    SELECT language, COUNT(*) FROM programming GROUP BY language;
...
""",
    "Avg Leadership & Presentation": """
        SELECT AVG(leadership), AVG(presentation) FROM soft_skills;
...
""",
    "Strong Interpersonal + Communication": """
        ...
        WHERE interpersonal_skills > 80 AND communication > 80;
...
""",
    "Mock Score >= 90": """
        SELECT * FROM placements WHERE mock_interview_score >= 90;
...
if selected_title != "-- Select a Query --" and st.button("Run Query"):
    st.write("Please hold on until we filter your data..")
    ...
    show_query_results(title=selected_title, query=query, csv_name="filtered_query_results.csv")
                                                                                       ...
                                                                                       # Get download button after gwtting results
